    ...
    constructor : function(config) {
        Ext.apply(config, {
            factoryNames : [
                ...
                'auscope.layer.querier.wfs.factories.MinOccViewFactory',
                'auscope.layer.querier.wfs.factories.MineralOccurrenceViewFactory',
                'auscope.layer.querier.wfs.factories.CommodityResourceViewFactory',
                'auscope.layer.querier.wfs.factories.MineViewFactory',
