...
public class EarthResourceService extends BaseWFSService {
     ...
     * @return
     */
    public String getMinOccViewFilter(String name, FilterBoundingBox bbox) {
        MinOccViewFilter filter = new MinOccViewFilter(name);
     ...
     * @return
     */
    public String getMiningActivityFilter(String mineName, FilterBoundingBox bbox) {
     ...
     * @throws URISyntaxException
     */
    public WFSCountResponse getMiningActivityCount(String serviceUrl, String mineName, FilterBoundingBox bbox, int maxFeatures) throws PortalServiceException, URISyntaxException {
        MiningActivityFilter filter = new MiningActivityFilter(mineName);
        String filterString = generateFilterString(filter, bbox);

        HttpRequestBase method = generateWFSRequest(serviceUrl, MINING_FEATURE_OCCURRENCE_FEATURE_TYPE, null, filterString,
                maxFeatures, null, ResultType.Hits);
        return getWfsFeatureCount(method);
    }
    ...
    public String getMineralOccurrenceViewFilter(String name, String commodityUri, String timescaleUri,
        ...
        MineralOccurrenceViewFilter filter = generateMineralOccurrenceViewFilter(name, commodityUri, timescaleUri);
        return generateFilterString(filter, bbox);
    ...
    /**
     * Generates a MineralOccurrenceView filter using single-values for commodity and timescale URIS
     * by taking all narrower and narrower transitive relationships from the given vocabularies.
     *
     * @param name
     * @param commodityUri
     * @param timescaleUri
     * @return
     */
    private MineralOccurrenceViewFilter generateMineralOccurrenceViewFilter(String name, String commodityUri, String timescaleUri) {
        ...
        return new MineralOccurrenceViewFilter(name, commodityUris, timescaleUris);
    }
