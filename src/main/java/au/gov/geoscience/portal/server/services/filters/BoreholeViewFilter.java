 ...
 */
@Service
public class BoreholeViewFilter extends BoreholeFilter {

	protected Boolean justNVCL;
	protected List<String> identifiers;
    // ----------------------------------------------------------- Constructors

    public BoreholeViewFilter() {
        // test
        super(null, null, null, null);
    }


    public BoreholeViewFilter(String boreholeName, String custodian, String dateOfDrilling, List<String> ids, List<String> identifiers, Boolean justNVCL) {
