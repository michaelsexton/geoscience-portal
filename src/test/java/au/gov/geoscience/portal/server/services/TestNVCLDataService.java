...
import au.gov.geoscience.portal.server.nvcldataservice.*;
import au.gov.geoscience.portal.server.services.methodmaker.NVCLDataServiceMethodMaker;
import au.gov.geoscience.portal.server.services.methodmaker.NVCLDataServiceMethodMaker.PlotScalarGraphType;
...
public class TestNVCLDataService extends PortalTestClass {
    ...
    public void testGetDatasetCollection() throws Exception {
        ...
        final String responseString = ResourceUtil
                .loadResourceAsString("au/gov/geoscience/portal/server/services/NVCL_GetDatasetCollectionResponse.xml");
    ...
    public void testGetLogCollection() throws Exception {
        ...
        final String responseString = ResourceUtil
                .loadResourceAsString("au/gov/geoscience/portal/server/services/NVCL_GetLogCollectionResponse.xml");
        final ByteArrayInputStream responseStream = new ByteArrayInputStream(responseString.getBytes());
